...
<head>
    ...
    <title>Instrucciones | Examen Psicométrico</title>
...
<main class="contenido">
    ...
    <section class="encabezado">
        ...
        <p>
Esta evaluación psicométrica mide tus habilidades cognitivas, competencias conductuales 
y el potencial técnico requerido para desempeñar con éxito las funciones del puesto solicitado.
 Su objetivo es identificar tus fortalezas y proyectar tu adaptación a los retos 
 diarios de la posición.
        </p>
    ...
    <section class="panel">
        ...
        <div class="acciones">
            ...
            @else
                <form
                    method="POST"
                    action="{{ route('candidato.psicometrico.iniciar') }}"
                >
                    @csrf
